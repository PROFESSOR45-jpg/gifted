...
global.caption = "*©𝟐𝟎𝟐𝟒 PROFESSOR TECH*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ PROFESSOR TECH*"; // Input Yours custom...(Maintain font for Flow)
 
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~XqwVRRIS#iwLNfRQ9fKAIR9g9EYGKWJCPMzdS2BFuJwVI4_Dgvjo", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "PROFESSOR TECH", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "PROFESSOR TECH ", // Added // Input Yours customers...
PACK_NAME: process.env.PACK_NAME || "PROFESSOR 💪", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "PROFESSOR TECH", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/gq4219.jpg", // You can Replace with yours...
