...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254112658916,254783601710", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
AUTO_LIKE_STATUS: process.env.AUTO_LIKE_STATUS || "true",
AUTO_LIKE_EMOJI: process.env.AUTO_LIKE_EMOJI || "💯", //Input Yours custom...
AUTO_REPLY_STATUS: process.env.AUTO_REPLY_STATUS || "false",
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ STATUS VIEWS BY PROFESSOR", // // Input Yours custom...
...
PACK_NAME: process.env.PACK_NAME || "PROFESSOR-TECH🫡", // Added // Input Yours custom...
