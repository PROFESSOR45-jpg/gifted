...
global.footer = "*POWERED BY PROFESSOR TECH*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~7mYjUKAD#ILj-4hZD17iuLLGYgLE_GAKuBYwbk_fQY8NdoYIK7E4", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
PACK_AUTHOR: process.env.PACK_AUTHOR || "PROFESSOR TECH", // Added // Input Yours custom...
...
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/k7hpz3.jpg", // You can Replace with yours...
